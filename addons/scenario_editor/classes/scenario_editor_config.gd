...
enum Types {TYPE_NIL, TYPE_BOOL, TYPE_INT, TYPE_FLOAT, TYPE_STRING, TYPE_VECTOR2, TYPE_VECTOR2I, TYPE_RECT2, TYPE_RECT2I, TYPE_VECTOR3, TYPE_VECTOR3I, TYPE_TRANSFORM2D, TYPE_VECTOR4, TYPE_VECTOR4I, TYPE_PLANE, TYPE_QUATERNION, TYPE_AABB, TYPE_BASIS, TYPE_TRANSFORM3D, TYPE_PROJECTION, TYPE_COLOR, TYPE_STRING_NAME, TYPE_NODE_PATH, TYPE_RID, TYPE_OBJECT, TYPE_CALLABLE, TYPE_SIGNAL, TYPE_DICTIONARY, TYPE_ARRAY, TYPE_PACKED_BYTE_ARRAY, TYPE_PACKED_INT32_ARRAY, TYPE_PACKED_INT64_ARRAY, TYPE_PACKED_FLOAT32_ARRAY, TYPE_PACKED_FLOAT64_ARRAY, TYPE_PACKED_STRING_ARRAY, TYPE_PACKED_VECTOR2_ARRAY, TYPE_PACKED_VECTOR3_ARRAY, TYPE_PACKED_COLOR_ARRAY, TYPE_PACKED_VECTOR4_ARRAY, TYPE_MAX, }
static var node_type_color: Dictionary = {
	TYPE_NIL: Color.ALICE_BLUE,
	TYPE_BOOL: Color.HOT_PINK,
	TYPE_INT: Color.AQUA,
	TYPE_FLOAT: Color.AQUAMARINE,
	TYPE_STRING: Color.AZURE,
	TYPE_VECTOR2: Color.BEIGE,
	TYPE_VECTOR2I: Color.BISQUE,
	TYPE_RECT2: Color.BLACK,
	TYPE_RECT2I: Color.BLANCHED_ALMOND,
	TYPE_VECTOR3: Color.BLUE,
	TYPE_VECTOR3I: Color.BLUE_VIOLET,
	TYPE_TRANSFORM2D: Color.BROWN,
	TYPE_VECTOR4: Color.BURLYWOOD,
	TYPE_VECTOR4I: Color.CADET_BLUE,
	TYPE_PLANE: Color.CHARTREUSE,
	TYPE_QUATERNION: Color.CHOCOLATE,
	TYPE_AABB: Color.CORAL,
	TYPE_BASIS: Color.CORNFLOWER_BLUE,
	TYPE_TRANSFORM3D: Color.CORNSILK,
	TYPE_PROJECTION: Color.CRIMSON,
	TYPE_COLOR: Color.CYAN,
	TYPE_STRING_NAME: Color.DARK_BLUE,
	TYPE_NODE_PATH: Color.DARK_CYAN,
	TYPE_RID: Color.DARK_GOLDENROD,
	TYPE_OBJECT: Color.DARK_GRAY,
	TYPE_CALLABLE: Color.DARK_GREEN,
	TYPE_SIGNAL: Color.DARK_KHAKI,
	TYPE_DICTIONARY: Color.DARK_MAGENTA,
	TYPE_ARRAY: Color.DARK_OLIVE_GREEN,
	TYPE_PACKED_BYTE_ARRAY: Color.DARK_ORANGE,
	TYPE_PACKED_INT32_ARRAY: Color.DARK_ORCHID,
	TYPE_PACKED_INT64_ARRAY: Color.DARK_RED,
	TYPE_PACKED_FLOAT32_ARRAY: Color.DARK_SALMON,
	TYPE_PACKED_FLOAT64_ARRAY: Color.DARK_SEA_GREEN,
	TYPE_PACKED_STRING_ARRAY: Color.DARK_SLATE_BLUE,
	TYPE_PACKED_VECTOR2_ARRAY: Color.DARK_SLATE_GRAY,
	TYPE_PACKED_VECTOR3_ARRAY: Color.DARK_TURQUOISE,
